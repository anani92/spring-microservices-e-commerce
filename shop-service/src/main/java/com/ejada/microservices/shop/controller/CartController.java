...
public class CartController {
	...
	public ResponseEntity<Cart> addToCart(@PathVariable("inventoryItemId")  Long inventoryItemId, @PathVariable("userId") Long userId,@PathVariable("quantity") Integer quantity,  @PathVariable("shopId") Long shopId) {
	...
	public ResponseEntity<String> deleteUserCart(@PathVariable("userId") Long userId) {
